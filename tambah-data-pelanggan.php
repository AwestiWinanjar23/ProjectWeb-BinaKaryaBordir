              ...
              <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-3 font-weight-bold text-primary">Form Tambah Data Pelanggan:</h6>
                    <div class="card-body">
                        <form method="POST" action="tambah-pelanggan-aksi.php">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nama Pelanggan*</label>
                                <input name="Nama_Pelanggan" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nama">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="No_Hp" type="number" class="form-control" id="exampleFormControlInput1" placeholder="+62">
                            </div>
