    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"></div>
        </li>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" align="center">Penghasilan bulanan</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800" align="center">Rp. 7.000.000</div>
                      </div>
                      <div class="col-auto">
              ...
              <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1" align="center">Penghasilan Tahunan</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800" align="center">Rp. 84.000.000</div>
                      </div>
                      <div class="col-auto">
                        <i class="far fa-credit-card fa-2x text-gray-300"></i>
                      </div>
              ...
              <div class="col-xl-4 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1" align="center">Jumlah Orderan</div>
                        <div class="row no-gutters align-items-center">
                          <div class="col-auto">
            ...
            <div>
            <img src="Banner-Bordir.jpg" height="300px" width="1075px">
            </div>
            <div class="col-xl-4 col-md-6 mb-4">   
            </div> 
            ...
            <div class="row">
              ...
              <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    <p><b>Jl. Sanggrahan, RT.04/RW.15, Sanggrahan, Kec. Grogol, Kabupaten Sukoharjo, Jawa Tengah 57552.</b></p> 
                    <br><br><br>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Aturan Kerja</h6>
                  </div>
                  <div class="card-body">
                    <ol>
                      <li>Jam Operasi Bk. Bina Karya Senin-Sabtu.</li>
                      <li>Kecuali ada deadline, harus diselesaikan secepatnya dan tepat waktu.</li>
                      <li>Jam kerja 2 shift (Siang dan Malam)</li>
                      <li>Dua orang Karyawan mendapatkan 12 jam per 1 shiftnya</li>
                    </ol>
                  </div>
                </div>
              </div>
