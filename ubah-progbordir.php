...
<html lang="en">
  <head>
    ...
    <!-- Page Ubah Data Progres Bordir-->
    <title>Ubah Data Progres Bordir</title>
              ...
              <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-3 font-weight-bold text-primary">Form Ubah Progress Bordir:</h6>
                        <div class="card-body">
                          <form method="POST" action="ubah-progbordir-aksi.php">
                                <?php
                                include "koneksi.php";                              
                                $ID_Progbordir=$_GET['ID_Progbordir'];
                                $query=mysqli_query($connect, "SELECT * FROM tb_progbordir where ID_Progbordir='$ID_Progbordir'");
                                while ($data = mysqli_fetch_array($query)) {
                                ?>
                                <input type="hidden" name="ID_Progbordir" value="<?php echo $_GET['ID_Progbordir'] ?>"/>
                                <div class="mb-3">
                                    <select name="ID_Pemesanan" class="form-select form-control">
                                        <?php
                                        $query=mysqli_query($connect, "SELECT * FROM tb_pemesanan");
                                  ...
                                  <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Status Bordiran</label><br>
                                    <div class="form-check">
                                        <input name="Status_Bordiran"  class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value=<?php echo $data['Status_Bordiran']; ?><?=$data['Status_Bordiran'] == "Selesai" ? " checked" : ""?>>
                                        <label class="form-check-label" for="flexRadioDefault1">Selesai</label>
                                    </div>
                                    <div class="form-check">
                                        <input name="Status_Bordiran" class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" value=<?php echo $data['Status_Bordiran']; ?><?=$data['Status_Bordiran'] == "Belum" ? " checked" : ""?>>
