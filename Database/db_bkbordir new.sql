...
(1, 'Laeliani', 'Boyolali Surakarta', '085825455427'),
(2, 'Anita Inayah', 'Karanganyar Surakarta', '083877455267');
...
(1, 1, 0, 250000, 'Bayar', 'nota.png'),
(2, 2, 10000, 1110000, 'Bayar', 'nota.png');
...
(1, 1, 100, '20x10 cm', '5 hari', 'Logo_2.jpeg', 'Diantar', 'Dijemput'),
(2, 2, 500, '12x22 cm', '7 hari', 'smk.jpeg', 'Diantar', 'Diantar');
...
--
ALTER TABLE `tb_progbordir`
  MODIFY `ID_Progbordir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
