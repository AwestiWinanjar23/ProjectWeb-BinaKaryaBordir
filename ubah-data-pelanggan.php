              ...
              <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-3 font-weight-bold text-primary">Form Ubah Data Pelanggan:</h6>
                        <div class="card-body">
                            <form method="POST" action="ubah-data-pelanggan-aksi.php">
                                <?php
                                include "koneksi.php";
                                $ID_Pelanggan=$_GET['ID_Pelanggan'];
                                $query= mysqli_query($connect,"select * from tb_pelanggan where ID_Pelanggan='$ID_Pelanggan'");
                                while($data=mysqli_fetch_array($query)){
                                    ?>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Nama Pelanggan*</label>
                                        <input name="Nama_Pelanggan" type="text" value="<?php echo $data['Nama_Pelanggan'];?>" class="form-control" id="exampleFormControlInput1" placeholder="Nama">
                                        <input name="ID_Pelanggan" type="hidden" value="<?php echo $data['ID_Pelanggan'];?>" class="form-control" id="exampleFormControlInput1" placeholder="Nama">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Alamat*</label>
                                        <input name="Alamat_Pelanggan" type="text" value="<?php echo $data['Alamat_Pelanggan'];?>"  class="form-control" id="exampleFormControlInput1" placeholder="Alamat">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">No_Hp*</label>
                                        <input name="No_Hp" type="number" value="<?php echo $data['No_Hp'];?>"  class="form-control" id="exampleFormControlInput1" placeholder="+62">
                                    </div>
